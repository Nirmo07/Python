...
save_csv(cleaned_data,"survey_lung_cancer_cleaned_data.csv")

load_cleaned_data=load_csv("survey_lung_cancer_cleaned_data.csv")
...
def analysis(lcd):
    ...
    return{
        ...
        "lung cancer yes data:":lung_cancer_yes_data
    }
